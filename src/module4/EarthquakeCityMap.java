...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		text("Ocean Quake", 75, 157);
		text("Size ~ Magnitude", 50, 187);
		text("Deep", 75, 230);
		...
		int numOceanQuakes = 0;
		        for (Marker cm : countryMarkers) {
		        	...
		        	for(Marker em : quakeMarkers) {
		        		...
		        		//This else statement will give wrong result as numOceanQuakes will increment again and again
		        		//for every country
		        		//else {
		        		//	numOceanQuakes++;
		        		//}
		        	}
		        	numOceanQuakes = totalQuakes-landQuakes;
		        	if(numQuakes != 0) {
